...
def store__inGrid( Data=None, inpFile=None, digit=5, \
                   x1MinMaxNum=None, x2MinMaxNum=None, x3MinMaxNum=None, \
                   xMin=None, yMin=None, zMin=None, xMax=None, yMax=None, zMax=None, LI=None, LJ=None, LK=None ):
    ...
    if ( Data is None ):
        if ( inpFile is None ):
            print( "[store__inGrid_python.py] Data & inpFile is None... ??? " )
            sys.exit()
        else:
